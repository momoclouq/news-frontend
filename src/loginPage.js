      ...
      <div class ="row">
        ...
        <div class="col-sm-6" style={{borderStyle: "groove"}}><br></br><br></br>
          <div class ="row">
            ...
            <div class="col-sm-7"><h2>TITLE HEADING</h2></div>
          </div><br></br>
          <div class ="row">
          ...
          <div class ="row">
            ...
            <div class="col-sm-1"></div>
            <div class="col-sm-6"><input type="text" class="form-control "placeholder="Password"></input></div>
            <div class="col-sm-1"></div>
          </div><br></br>
          <div class ="row">
            <div class="col-sm-5"></div>
            <div class="col-sm-7"><button type="submit" class="btn" style={{backgroundColor: "lightgreen", width: "150px", height: "35px"}}>Login</button></div>
          </div><br></br>
        </div>
        <div class="col-sm-3"></div>
      </div>
