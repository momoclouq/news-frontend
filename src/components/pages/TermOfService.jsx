    ...
    return (
        <div className="container pt-5 pb-3">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to My Site, accessible from <a href="http://www.mysite.com" rel="external nofollow noopener">http://www.mysite.com</a></p>
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    <p>By mail: 767 Fifth Avenue New York, NY 10153, United States</p>
                </li>
            </ul>
        </div>
    )
